#
# COMP1521 Lab 04 Exercise - MIPS 2d array
#
...
main:
	...
	la	$t2, array	# array[0][0]
	mul	$t3, $t0, 24	# x * N_COLS (go through every row before row with the value)
	add	$t3, $t3, $t1	# x * N_COLS + x (go through every element before the value within the row)
	mul	$t4, $t3, 4	# 4 * i
	add	$t4, $t4, $t2	# array[0][0] + number of arrays before the value
	lw	$a0, ($t4)	# array[x][y]
